...
class Octopush_Sms_Admin {
    ...
    public function __construct($octopush_sms, $version) {
        ...
        $this->admin_config = array(
            'action_create_account' => __('Create account', 'octopush-sms'), //don't suppress                
            'action_send_message' => __('Send Message', 'octopush-sms'),
            'action_validate_order' => __('Validate Order', 'octopush-sms'),
            //'action_order_return' => __('Order return', 'octopush-sms'),
            'action_update_quantity' => __('Stock notification', 'octopush-sms'),
            'action_admin_alert' => __('Admin alert', 'octopush-sms'),
            'action_daily_report' => __('Daily report', 'octopush-sms'));

        $this->customer_config = array(
            'action_create_account' => __('Create account', 'octopush-sms'),
    ...
    public function get_status($status) {
        switch ($status) {
            ...
            case 4:
                return __('Canceled', 'octopush-sms');
            case 5:
